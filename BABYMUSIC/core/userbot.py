...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("BABY09_WORLD")
                await self.two.join_chat("BABY09_WORLD")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("BABY09_WORLD")
                await self.three.join_chat("BABY09_WORLD")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("BABY09_WORLD")
                await self.four.join_chat("BABY09_WORLD")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("BABY09_WORLD")
                await self.five.join_chat("BABY09_WORLD")
            except:
                pass
            assistants.append(5)
