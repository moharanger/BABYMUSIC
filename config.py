...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BABY-MUSIC/BABYMUSIC",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+B31P_If87s43NDA1")
